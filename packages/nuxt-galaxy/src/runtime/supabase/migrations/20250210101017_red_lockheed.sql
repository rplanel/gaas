...
CREATE VIEW "galaxy"."analysis_details" AS (select "galaxy"."workflows"."id", "galaxy"."workflows"."name", "galaxy"."jobs"."state", "galaxy"."analyses"."parameters", "galaxy"."analyses"."datamap", "galaxy"."jobs"."created_at", "galaxy"."jobs"."owner_id", "galaxy"."analyses"."history_id", "galaxy"."analyses"."workflow_id", "galaxy"."workflows"."galaxy_id", "galaxy"."jobs"."stderr", "galaxy"."jobs"."stdout", "galaxy"."analyses"."invocation", "galaxy"."jobs"."is_sync", "galaxy"."workflows"."user_id", "galaxy"."histories"."is_deleted", "galaxy"."workflows"."annotation", "galaxy"."jobs"."tool_id", "galaxy"."jobs"."exit_code", "galaxy"."jobs"."step_id", "galaxy"."jobs"."analysis_id", "galaxy"."workflows"."version", "galaxy"."workflows"."definition" from "galaxy"."analyses" inner join "galaxy"."histories" on "galaxy"."analyses"."history_id" = "galaxy"."histories"."id" inner join "galaxy"."jobs" on "galaxy"."analyses"."id" = "galaxy"."jobs"."analysis_id" inner join "galaxy"."workflows" on "galaxy"."analyses"."workflow_id" = "galaxy"."workflows"."id");--> statement-breakpoint
...
CREATE VIEW "galaxy"."datasets_with_storage_path" AS (select "storage"."objects"."id", "galaxy"."datasets"."owner_id", "galaxy"."datasets"."history_id", "galaxy"."datasets"."storage_object_id", "storage"."objects"."created_at", "galaxy"."datasets"."uuid", "galaxy"."datasets"."extension", "galaxy"."datasets"."data_lines", "galaxy"."datasets"."dataset_name", "galaxy"."datasets"."galaxy_id", "galaxy"."datasets"."annotation", "storage"."objects"."name", "storage"."objects"."metadata" from "galaxy"."datasets" inner join "storage"."objects" on "galaxy"."datasets"."storage_object_id" = "storage"."objects"."id");--> statement-breakpoint
